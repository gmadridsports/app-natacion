...
import 'login_user_approval_test.dart' as login_user_approval_test;
import 'main_test.dart' as main_test;
import 'open_unauth_login_test.dart' as open_unauth_login_test;
...
Future<void> main() async {
  ...
  group('login_user_approval_test', login_user_approval_test.main);
  group('main_test', main_test.main);
  group('open_unauth_login_test', open_unauth_login_test.main);
